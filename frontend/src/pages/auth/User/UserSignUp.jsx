      ...
      <div className='w-full max-w-md px-2 sm:px-0'>
        ...
        <div className='bg-white rounded-2xl shadow-xl p-8'>
          ...
          <button
            ...
            type='button'
            className='w-full cursor-pointer flex items-center justify-center gap-3 bg-white border-2 border-gray-300 hover:border-gray-400 hover:shadow-md text-gray-700 font-semibold rounded-xl px-4 py-3 transition-all duration-200 mt-2'>
          ...
          <p className='text-center mt-6 text-gray-600'>
            Already have an account? <Link to='/login' className='text-blue-600 hover:text-blue-700 font-semibold hover:underline'>Sign In</Link>
          </p>

          {/* Captain Sign Up */}
          <p className='text-center mt-4 text-gray-600'>
            <Link to='/captain-signup' className='text-green-600 hover:text-green-700 font-semibold hover:underline'>Register as Captain</Link>
          </p>
        </div>
      </div>
    </div>
